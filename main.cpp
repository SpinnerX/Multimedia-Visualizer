...
AVPacket* packet = av_packet_alloc(); //! @note av_init_packet(&packet) is deprecated, and instead USE av_packet_alloc()
...
// std::string mediaTypeToString(AVMediaType type){
//     switch (type) {
...
//     default: return "No MediaType String was valid!";
//     }

//     return "No MediaType String was valid!";
// }
...
//     GLFWwindow* window = glfwCreateWindow(vr_state.width, vr_state.height, "Hello World", NULL, NULL);
...
//     c->bit_rate = 64    c->sample_rate = 441    c->channels = 2;
...
//     audio_outbuf_size = 1;
//     audio_outbuf = av_malloc((size_t)audio_outbuf_size);

//     /* ugly hack for PCM codecs (will be removed ASAP with new PCM
//        support to compute the input frame size in samples */
//     if (c->frame_size <= 1) {
//         // audio_input_frame_size = audio_outbuf_size / c->channels;
//         audio_input_frame_size = audio_outbuf_size / c->extra_hw_frames;
...
//     }
//     samples = av_malloc(audio_input_frame_size * 2 * c->);
// }
...
//     /* put sample parameters */
//     c->bit_rate = 4    /* resolution must be a multiple of two */
//     c->width = 352;
//     c->height = 288;
...
//         video_outbuf_size = 2        video_outbuf = av_malloc(video_outbuf_size);
//     }
